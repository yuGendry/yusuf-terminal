...
const TOURS = {
  ...
  2: [
    ...
    ['glaze-bench',  [8.6, 1.2, -25.4], 0,             0.02],
    ['works-order',  [8.0, 1.2, -27.4], -Math.PI / 2,  0.06],
  ...
  3: [
    ...
    ['green-room',   [20, 1.2, 6.0],   0,              0.06],
    ['lantern',      [20, 1.2, 4.0],   0,              0.16],
    ['projection',   [20, 1.2, 0.5],   0,              0.10],
