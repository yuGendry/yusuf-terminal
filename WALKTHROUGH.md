...
Go **north** into the theatre. Three grey boxes are mounted on the side walls.

Wear the mask. Each box shows a glowing cable running to whatever it actually
feeds. Only one runs **forward toward the stage** — that is the one you want.

> **Answer:** the breaker on the **east wall, about halfway down the house**.

The other two are not failure states. One is dead. One brings the house lights
up, which wakes something in the rigging early — you can switch it back off.
...
Twelve across the game; eight exist so far. Finding all twelve changes the
ending. They glow faintly through the **Threadlight** lens — Wren handled every
one of them.

| Chapter | Where |
| --- | --- |
| 1 | Lobby floor near the entrance · east wall of the house, in the seating · the catwalk above the stage |
