...
export const CHAPTERS = [
  ...
  },
  {
    ...
    lens: null,
    lensName: null,
    // Zero, deliberately. All twelve stubs are in chapters 1 to 4 — Wren hid
    // one in every room she was ever left alone in, and she was never left
    // alone on the stage. It also keeps TOTAL_STUBS at the twelve the prose,
    // the archive and the ending condition all say.
    stubs: 0,
    notes: 3,
    tapes: 1,
    estimatedMinutes: 16,
